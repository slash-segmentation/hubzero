...
<script type="text/javascript" charset="utf8" src="/media/DataTables-1.10.1/js/jquery.dataTables.js"></script>
	...
	<div id="content-header" class="full">
		...
		<div>Description: <?php echo nl2br($this->workflow->description); ?></div>
	</div><!-- / #content-header -->
...
$(document).ready(function() {
	var wf_array = <?php echo json_encode($wf_array); ?>;
	var alpaca_file_ids = <?php echo $this->alpaca_file_id; ?>;
